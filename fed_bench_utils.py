...
# def partition_data(dataset, datadir, logdir, partition, n_parties, beta=100):
def partition_data(dataset, datadir, logdir, partition, n_parties, beta=0.4, random_seed=0):
# def partition_data(dataset, datadir, logdir, partition, n_parties, beta=0.1):
    ...
    if partition == "homo":
        ...
        all_C = sorted(list(set(y_train).union(set(y_test))))
        ...
        while min_size < min_require_size:
            ...
            rseed+=1
            # print(min_size, min_require_size, K)
            ...
            for k in all_C:
                ...
                proportions = dirichlet.rvs(np.repeat(beta, n_parties), size=1, random_state=rseed)[0]
                # print(proportions)
                # exit()
